...
--
-- This belongs to its OWN Supabase project. It shares no table, no schema and no
-- credential with The Signal. Everything is prefixed aw_ so that even if the two ever
-- land in one database by accident, nothing collides and nothing is ambiguous.
--
...
-- through the service role on the server, exactly as The Signal does it.
-- ---------------------------------------------------------------------------
